<?php 
	...
	if (isset($_POST['addActivity'])) {
		...
		// if ($file_type == "Student Information Sheet") {
			...
			$sql = "INSERT INTO lcstudentorgtable (file_type, student_lastname, student_firstname, student_middlename, student_year, student_course_section, student_number, filename, status, submission_date, student_code) VALUES ('$file_type', '$student_lastname', '$student_firstname', 'student_middlename', '$student_year', '$student_course_section', '$student_contact', '$file_name', '$status', '$sub_date', '$studentCode')";
