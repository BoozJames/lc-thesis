...
<button class="btn btn-primary bg-success" type="button" data-bs-target="#modal-2<?php echo $row['id']?>" data-bs-toggle="modal"><i class="fas fa-eye"></i></button><button class="btn btn-primary bg-danger" type="button" data-bs-target="#modal-3" data-bs-toggle="modal"><i class="fas fa-trash-alt"></i></button></div>
                                                                            </td>
                    ...
                    <form action="back_end/updateCounselorRecord.php" method="post">
                        ...
                        <div class="row" style="margin-top: 10px;">
                            <div class="col text-center text-light">
								<label class="col-form-label bg-dark d-block" style="font-family: Alatsi, sans-serif;">PSYCHOLOGICAL TEST RESULT</label></div>
                        </div>
                        <div class="row">
