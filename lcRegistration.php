                    ...
                    <div class="card-body">
                        ...
                        <form action="back_end/addAdmin.php" method="POST">
                            ...
                            <div class="row" style="margin-top: 10px;">
                                ...
                                <div class="col d-lg-flex align-items-lg-center"><select class="form-select" data-bs-toggle="tooltip" data-bss-tooltip="" name="adminGender" placeholder="Male - Female" required="" style="font-family: Alatsi, sans-serif;border-style: none;border-bottom-style: solid;border-bottom-color: var(--bs-gray-900);">
